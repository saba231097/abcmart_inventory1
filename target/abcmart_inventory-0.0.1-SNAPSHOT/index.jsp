        ...
        <div class="col-md-6 d-flex align-items-center justify-content-center">
            <div class="card shadow p-4">
                ...
                <form action="authUser" method="post">
                	<h3 id="errLoginMsg" style="color:red; display:none">Email Id or Password is incorrect !!!</h3>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="secrets" name="secrets" placeholder="********" required>
                    </div>
